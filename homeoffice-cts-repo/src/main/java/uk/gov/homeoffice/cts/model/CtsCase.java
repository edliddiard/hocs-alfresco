...
public class CtsCase extends Folder {
    ...
    public CtsCase(Map<QName, Serializable> caseProps) {
        ...
        this.isLinkedCase = (String)caseProps.get(CtsModel.PROP_IS_LINKED_CASE);
        ...
        this.isGroupedSlave = (String)caseProps.get(CtsModel.PROP_IS_GROUPED_SLAVE);
        this.isGroupedMaster = (String)caseProps.get(CtsModel.PROP_IS_GROUPED_MASTER);
    ...
    public String getIsGroupedSlave() {
        return isGroupedSlave;
    }

    public void setIsGroupedSlave(String isGroupedSlave) {
        this.isGroupedSlave = isGroupedSlave;
    }

    public String getIsGroupedMaster() {
        return isGroupedMaster;
    }

    public void setIsGroupedMaster(String isGroupedMaster) {
    ...
    public String getIsLinkedCase() {
        return isLinkedCase;
    }

    public void setIsLinkedCase(String isLinkedCase) {
