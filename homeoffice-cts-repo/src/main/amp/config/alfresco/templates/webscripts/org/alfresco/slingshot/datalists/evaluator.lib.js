 ...
 *
 This is a CTS override of an Alfresco class. I have commented changes with CTS label.
 This fixes a bug where an authority is treated as a container so does not display correctly in
 a datalist. Chris Davidson
 */
...
var Evaluator =
{
   ...
   decorateFieldData: function Evaluator_decorateFieldData(objData, node)
   {
      ...
      //CTS Added this method to populate a group
	  else if (type == "cm:authority")
      {
